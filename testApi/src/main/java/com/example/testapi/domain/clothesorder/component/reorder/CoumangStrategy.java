...
@Component
public class CoumangStrategy implements RestockStrategy{

    private final RestockRepository restockRepository;

    @Override
    public boolean isSuppored(VenderType venderType) {
        return venderType == VenderType.COUMANG;
    }
    ...
    public void requestRestock(String itemName, int stock) {
        ...
        try{
            ...
            log.info("[재입고 요청 테이블 저장 완료] 벤더사: COUMANG 아이템: {} 재입고 재고: {}",itemName,stock );
